#!/usr/bin/env python3
"""
Rechunk + embed pojedynczej pracy (dev / reprocess) oraz budowanie indeksów.

  python rechunk.py --arxiv-id 2605.08376
  python rechunk.py --build-indexes
"""
...
def process_paper(paper: dict) -> None:
    ...
    logger.info("[%s] Start rechunk", arxiv_id)
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Rechunk pojedynczej pracy (parent-child)")
