-- Scholarly v2: ParadeDB (pg_search + pgvector), parent-child chunks, hybrid retrieval
...
-- Golden QA (chunk_id uzupełniane po rechunk v2)
...
-- Indeksy wyszukiwania tworzone PO zasileniu danych (rechunk_v2 --build-indexes):
